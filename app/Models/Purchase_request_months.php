...
class Purchase_request_months extends Model
{
    protected $guarded = [];
    protected $appends = ['attachment_type_name','location_name','supplier_name','itemcategory_name', 'warehouse_name'];
	...
	public static function getNextCounterId($location_id) {
      ...
      // get last count
      $purchase_request = Purchase_request_months::select('location_id')
